    ...
    return (
        <section className="flex min-h-[210px] w-full flex-col flex-wrap justify-between rounded-[14px] bg-dark-1 px-5 py-8 xl:max-w-[568px]">
            ...
            <article className={cn("flex justify-center relative", {})}>
                <div
                    className={`relative flex w-full p-1 max-sm:hidden ${isPreviousMeeting ? "-top-4" : ""
                        }`}
                >
                ...
                {!isPreviousMeeting && (
                    <div className="gap-2 md:relative flex-items md:-top-10">
                        <button
                            onClick={handleClick}
                            className="px-6 rounded bg-[#0E78F9] text-md p-[4px] flex-center whitespace-nowrap bg-blue-1"
                        >
                            {buttonIcon1 && (
